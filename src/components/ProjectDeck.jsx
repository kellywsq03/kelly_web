...
export default function ProjectDeck({ openProject, onToggle }) {
  ...
  return (
    <section className="wrap" id="projects">
      <div className="section-head" data-reveal data-reveal-once><div className="terminal-section-heading"><div className="typed-kicker-shell"><div className="section-kicker typed-kicker">projects // click a process</div></div><h2 className="section-title-pill" data-reveal style={{ '--reveal-delay': '180ms' }}>projects.exe</h2></div></div>
